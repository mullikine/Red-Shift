   ...
   <xsl:template match="/">
      ...
      <html>
         ...
         <head>
            ...
            <style>
               h1                   { color: #000080; margin-left: 0; font-family: 'BankGothic Lt BT','Square721BT','ISOCTEUR','Eurasia','Letter Gothic'; }
               h2                   { color: #000080; margin-left: 20; font-family: 'BankGothic Lt BT','Square721BT','ISOCTEUR','Eurasia','Letter Gothic'; }
               h3                   { color: #000080; margin-left: 40; font-family: 'BankGothic Lt BT','Square721BT','ISOCTEUR','Eurasia','Letter Gothic'; }
               h4                   { color: #000080; margin-left: 60; font-family: 'BankGothic Lt BT','Square721BT','ISOCTEUR','Eurasia','Letter Gothic'; }
               h5                   { color: #000080; margin-left: 80; font-family: 'BankGothic Lt BT','Square721BT','ISOCTEUR','Eurasia','Letter Gothic'; }
               h6                   { color: #000080; margin-left: 100; font-family: 'BankGothic Lt BT','Square721BT','ISOCTEUR','Eurasia','Letter Gothic'; }
         ...
         <body>
            <h1>Red Shift 1.3.7 Source Code Documentation</h1>
